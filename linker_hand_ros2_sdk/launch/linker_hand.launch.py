    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[{
                ...
                'can': 'can0', # Change to the actual CAN bus name; on Windows it might be PCAN_USBBUS1
                "modbus": "None" # "None" | "/dev/ttyUSB0" — change to the actual Modbus bus name; on Windows use COM*, on Ubuntu use /dev/ttyUSB*. Note: add permissions with sudo chmod 777 /dev/ttyUSB*
            }],
        ),
    ])
